	...
	(
		select
			...
			case
					...
					when a.map_id = 85133																						then 0 /*Adding in improved phasing for East River Realty Co*/
			...
			case
					...
					when a.map_id = 85133																						then .5 /*Adding in improved phasing for East River Realty Co*/
