...
drop table if exists lg_Known_Projects_DB_20190913;

select
	*
into
	lg_Known_Projects_DB_20190913
from
(
	select
		*
...
select cdb_cartodbfytable('capitalplanning','lg_Known_Projects_DB_20190913') ;
