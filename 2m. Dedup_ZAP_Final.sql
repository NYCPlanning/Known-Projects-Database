...
(
	select
		...
		case
			...
			/*Adding in conditions for non-ULURP projects. Note that some non-ULURP FRESH projects are labeled
				as ULURP*/
			when concat(project_name,project_description,project_brief) 			like '%FRESH%'					then 1
								
			/*Adding in conditions for non-ULURP subdivisions and school seat certs*/					
			when 	ulurp = 'Non-ULURP' and
					concat(project_name,project_description,project_brief) 			like '%SD%' or 								
				 	concat(project_name,project_description,project_brief) 			like '%SS%' or								
				 	(upper(concat(project_name,project_description,project_brief)) 	like '%SUBDIVISION%' and
				  	project_id like '%R%')																			then 1
		

			/*Adding in conditions for non-ULURP subway and MTA projects*/
			when 	ulurp = 'Non-ULURP' and
					upper(concat(project_name,project_description,project_brief)) 	like '%SUBWAY%' or
				 	concat(project_name,project_description,project_brief) 			like '%MTA%'					then 0

			/*Adding in conditions for non-ULURP waterfront*/
			when 	ulurp = 'Non-ULURP' and
					upper(concat(project_name,project_description,project_brief)) 	like '%WATERFRONT%'				then 1
		...
		case
			...
			/*Adding in conditions for non-ULURP projects. Note that some non-ULURP FRESH projects are labeled
				as ULURP*/
			when concat(project_name,project_description,project_brief) 			like '%FRESH%'					then 0
			...
			when 	ulurp = 'Non-ULURP' and
					concat(project_name,project_description,project_brief) 			like '%SD%' or 								
				 	concat(project_name,project_description,project_brief) 			like '%SS%' or								
				 	(upper(concat(project_name,project_description,project_brief)) 	like '%SUBDIVISION%' and
				  	project_id like '%R%')																			then 0
		

			/*Adding in conditions for non-ULURP subway and MTA projects*/
			when 	ulurp = 'Non-ULURP' and
					upper(concat(project_name,project_description,project_brief)) 	like '%SUBWAY%' or
				 	concat(project_name,project_description,project_brief) 			like '%MTA%'					then 1

			/*Adding in conditions for non-ULURP waterfront*/
			when 	ulurp = 'Non-ULURP' and
					upper(concat(project_name,project_description,project_brief)) 	like '%WATERFRONT%'				then 0
